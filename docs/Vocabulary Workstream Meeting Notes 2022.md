...
# CDF Events SIG Meeting Notes - 2022
...
- Jalander Ramagiri, Ericsson Software Techonology

### Agenda
- FYI: New timeslot for APAC friendly CDEvents workgroup meeting since today
    - https://time.is/11am_19_december_2022_in_UTC

- SIG Events meeting focus
    - Presentations
    - Interactions with other SIGs
    - Non-CDEvents specific event architecture for CI/CD
    - Held on demand (if there is an agenda)

- Meetings during coming holidays
    - Dec 27th CDEvents WG cancelled
    - Jan 2nd SIG Events & CDEvents WG cancelled
    - Next CDEvents WG Jan 10th
    - Next SIG Events meeting (if agenda) Jan 16th

- Updates From TOC and Other SIGs

- Spinnaker PR for CDEvents PoC
...
- FYI: CDEvents v0.2
    - https://github.com/orgs/cdevents/projects/1/views/8
    - Feel free to help out reaching v0.2!
...
- Action Items From Last meeting
    - CDF Outreach Committee: Andrea will represent CDEvents

- Updates From TOC and Other SIGs
    - CDF TOC
        - Project presentations to the TOC
        - Tomorrow Andrea will present a CDEvents project update to the TOC
        - Planning on using a revised version of https://github.com/afrittoli/cdevents_roadmap/blob/main/cdevents_roadmap.pdf
        - Anything additional to be included?
            - Website refresh
            - Encouraging people to get involved
    - SIG Interoperability
        - White paper is being worked on
        - We could refer to CDEvents in the white paper
            - At the time of the original edits we talked about generic events
    - SIG Best Practices
        - Updated the best practices site to link to CDEvents
        - https://bestpractices.cd.foundation/resources/cdevents/ 

- cdevents.dev refresh
    - TWO PRs pending review
        - [Website (must merge first)](https://github.com/cdevents/cdevents.dev/pull/28)
        - [Spec](https://github.com/cdevents/spec/pull/103)

- Best Practices SIG
    - Future scope of CDEvents
    - Extend the scope of CDEvents to cover the full supply chain
    - Facilitate coverage of DORA metrics
    - Existing categories (engineering perspective): Core, SCM, CI, CD
    - We need new categories
        - Operations: Events related to the production environment
            - Users using the service
            - Incidents
        - Customer product
            - Overarching process
            - Define experiments with the customer
            - Execute
            - Collect Data
        - Supply Chain
            - Input & Output events
                - End of life, CVEs
            - Tie back to the best practices definition
        - Start defining categories and documenting them in the primer
        - Make it easier for people to contribute
        - (A) Create overarching issue (Andrea)
            -> Create bucket specific issues
            -> Create bucket docs
            -> Draft events
...
- Updates From TOC and Other SIGs
    ...
    - CDF Outreach Committee
        - Representation from CDEvents is requested
        - [Reboot presentation](https://drive.google.com/file/d/1Gzk55KJ0LN0eRBL_6tzDX3Z8TlfNSYAi/view)
    - SIG Interoperability, Best Practices, Software Supply Chain
        - [SIG Interop whitepaper](https://docs.google.com/document/d/1o5jHbuEQuspwYOruVB4L5-rG8E1wQm5chq8QN7BrrBs/edit#) is being reinitiated
...
- [cdevents.dev website refresh](https://github.com/cdevents/cdevents.dev/issues/12)
    - Current focus is on
        - [Root page](https://github.com/cdevents/cdevents.dev/pull/22) - [preview](https://deploy-preview-22--cdevents.netlify.app/)
        - [Spec Documentation Main Page](https://github.com/cdevents/spec/pull/95) - [preview](https://deploy-preview-24--cdevents.netlify.app/docs/)
    - Issue with too low contrast ratio for links on root page due to Docsy limitations
...
- Website revamp
    ...
    - Topics to be clarified
        ...
        - Target devices for website [Issue](https://github.com/cdevents/cdevents.dev/issues/16)
        - Process for managing content revisions [Issue](https://github.com/cdevents/cdevents.dev/issues/15)
